...
<div >
  ...
  <div className="ml-8">
    ...
    >
      <Form className='flex justify-center items-center p-7 flex-col'>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-4">
                ...
                <Field name="username" type="text" id="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="janesmith" />
          ...
          <div className="flex items-center justify-end w-full mt-7 gap-5">
   ...
   {/* <form className='flex justify-center items-center p-7 flex-col' onSubmit={handleFormSubmit} >
    <div className="space-y-12">
      <div className="border-b border-gray-900/10 pb-12">
        <h2 className="text-base font-semibold leading-7 text-gray-900">Profile</h2>
